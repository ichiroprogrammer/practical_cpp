...
* [自動単体テスト](process_and_infra.md#SS_8_2_1) 
* [自動統合テスト](process_and_infra.md#SS_8_2_3)
* [コードインスペクション](process_and_infra.md#SS_8_2_5_1_2)
* ツールによるコード解析
...
また、演習や悪例として使用するコードに関しては、あえて問題のあるコードを記述するため、
...
従って、[CI(継続的インテグレーション)](process_and_infra.md#SS_8_2_5)の一環で行われる
[自動単体テスト](process_and_infra.md#SS_8_2_1)や[自動統合テスト](process_and_infra.md#SS_8_2_3)でのsanitizerの使用を薦める。
...
上記や「[CI項目の例](process_and_infra.md#SS_8_2_5_5)」で述べたように自動化によって、こういったロスを回避しつつ、
