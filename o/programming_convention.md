...
[パッケージとその構成ファイル](programming_convention.md#SS_3_7)  
&emsp;[パッケージの実装と公開](programming_convention.md#SS_3_7_1)  
&emsp;[識別子の宣言、定義](programming_convention.md#SS_3_7_2)  
&emsp;[依存関係](programming_convention.md#SS_3_7_3)  
&emsp;[二重読み込みの防御](programming_convention.md#SS_3_7_4)  
&emsp;[ヘッダファイル内の#include](programming_convention.md#SS_3_7_5)  
&emsp;[#includeするファイルの順番](programming_convention.md#SS_3_7_6)  
&emsp;[#includeで指定するパス名](programming_convention.md#SS_3_7_7)  
...
* パッケージに関して、以下の構造を持つようにソースコードを構成する
  (「[Modern CMake project layoutのカスタマイズ](cpp_idioms.md#SS_12_10_1)」参照)。
    * ソフトウェアはパッケージに分割される。
