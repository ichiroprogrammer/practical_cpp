&emsp;[g++](cpp_idioms.md#SS_12_15_1)  
&emsp;[clang++](cpp_idioms.md#SS_12_15_2)  

[非ソフトウェア用語](cpp_idioms.md#SS_12_16)  
&emsp;[セマンティクス](cpp_idioms.md#SS_12_16_1)  
&emsp;[割れ窓理論](cpp_idioms.md#SS_12_16_2)  
&emsp;[車輪の再発明](cpp_idioms.md#SS_12_16_3)  

[DAG(有向非循環グラフ)](cpp_idioms.md#SS_12_17)  
...
## イディオム <a id="SS_12_1"></a>

### ガード節(Early Return) <a id="SS_12_1_1"></a>
ガード節とは、
...
[特殊メンバ関数](core_lang_spec.md#SS_10_6_1)では機能が不十分であることが多い。
...
* copy代入演算子には、[エクセプション安全性の保証](core_lang_spec.md#SS_10_13_7)がない。
...
これにより[エクセプション安全性の保証](core_lang_spec.md#SS_10_13_7)を持つ4関数をコードクローンすることなく実装できる。
...
以下にこのパターンを使用した[ミックスイン](cpp_idioms.md#SS_12_14_7)の例を示す。
...
なお、このパターンは、[std::enable_shared_from_this](stdlib_and_concepts.md#SS_11_6_2_2)の使用において前提知識となっている。
...
## 実装パターン <a id="SS_12_2"></a>
### Pimpl <a id="SS_12_2_1"></a>
...
### lightweight Pimpl <a id="SS_12_2_2"></a>
[Pimpl](cpp_idioms.md#SS_12_2_1)の解説で示したように依存関係をシンプルに保つには極めて有効なパターンではあるが、
...
ヒープ以外のメモリからnewするための[プレースメントnew](core_lang_spec.md#SS_10_6_9)を使用しているため、
...
### Cでのクラス表現 <a id="SS_12_2_6"></a>
このドキュメントは、C++でのソフトウェア開発を前提としているため、
ここで示したコードもC++で書いているが、

* 何らかの事情でCを使わざるを得ないプログラマがデザインパターンを使用できるようにする
* クラスの理解が曖昧なC++プログラマの理解を助ける(「[ポリモーフィックなクラス](core_lang_spec.md#SS_10_4_8)」参照)
...
## オブジェクト指向 <a id="SS_12_3"></a>
### is-a <a id="SS_12_3_1"></a>
...
kyukanchoとstd::stringの関係を[has-a](cpp_idioms.md#SS_12_3_2)の関係と呼ぶ。

---

### has-a <a id="SS_12_3_2"></a>
「has-a」の関係は、
...
### is-implemented-in-terms-of <a id="SS_12_3_3"></a>
...
自身の機能を提供する場合に使われる。
[has-a](cpp_idioms.md#SS_12_3_2)の関係は、is-implemented-in-terms-of の関係の一種である。

is-implemented-in-terms-ofは下記の手段1-3に示した方法がある。

* 手段1.[public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_12_3_3_1)  
* 手段2.[private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_12_3_3_2)  
* 手段3.[コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_12_3_3_3)  
...
手段1は[is-a](cpp_idioms.md#SS_12_3_1)に見え、以下に示すような問題も考慮する必要があるため、
可読性、保守性を劣化させる可能性がある。
...
#### public継承によるis-implemented-in-terms-of <a id="SS_12_3_3_1"></a>
...
すでに述べたようにこの方法は、
[private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_12_3_3_2)や、
[コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_12_3_3_3)
と比べコードがシンプルになる。 

#### private継承によるis-implemented-in-terms-of <a id="SS_12_3_3_2"></a>
...
この方法は、[public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_12_3_3_1)が持つデストラクタ問題は発生せす、
[is-a](cpp_idioms.md#SS_12_3_1)と誤解してしまう問題も発生しない。


#### コンポジションによる(has-a)is-implemented-in-terms-of <a id="SS_12_3_3_3"></a>
...
## オブジェクトの所有権 <a id="SS_12_4"></a>
### オブジェクトの排他所有 <a id="SS_12_4_1"></a>
...
オブジェクトの所有権やその移動、
std::unique_ptr、std::move()、[rvalue](core_lang_spec.md#SS_10_7_1_2)の関係を解説する。
...
下記に示した上記クラスの単体テストにより、
オブジェクトの所有権やその移動、共有、
std::shared_ptr、std::move()、[rvalue](core_lang_spec.md#SS_10_7_1_2)の関係を解説する。
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_12_16_1)に沿っておらず、
...
X、Yオブジェクトへの[ハンドル](cpp_idioms.md#SS_12_14_8)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。

---

## copy/moveと等価性のセマンティクス <a id="SS_12_5"></a>
### 等価性のセマンティクス <a id="SS_12_5_1"></a>
...
組み込みの==やオーバーロード[==演算子](core_lang_spec.md#SS_10_6_3)のこのような性質をここでは「等価性のセマンティクス」と呼ぶ。
...
この問題は、「[RTTI](core_lang_spec.md#SS_10_4_9)」使った下記のようなコードで対処できる。
...
文字列リテラルからstd::stringへの[暗黙の型変換](core_lang_spec.md#SS_10_6_2_2)が起こるために成立する。

以上で見てきたように、等価性のセマンティクスを守ったoperator==の実装には多くの観点が必要になる。

---

### copyセマンティクス <a id="SS_12_5_2"></a>
copyセマンティクスとは以下を満たすようなセマンティクスである。

* a = bが行われた後に、aとbが等価である。
* a = bが行われた前後でbの値が変わっていない。

従って、これらのオブジェクトに対して[等価性のセマンティクス](cpp_idioms.md#SS_12_5_1)
...
下記の単体テストから明らかな通り、
「[等価性のセマンティクス](cpp_idioms.md#SS_12_5_1)」で示した最後の例も、copyセマンティクスを満たしていない。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_12_12_3)が起こるためである。


---

### moveセマンティクス <a id="SS_12_5_3"></a>
...
* リソース管理   
    必須ではないが、aがポインタ等のリソースを保有している場合、
     move代入後にはそのリソースはcに移動していることが一般的である(「[rvalue](core_lang_spec.md#SS_10_7_1_2)」参照)

* エクセプション安全性  
    [no-fail保証](core_lang_spec.md#SS_10_13_7_1)をする(noexceptと宣言し、エクセプションをthrowしない)
...
### MoveAssignable要件 <a id="SS_12_5_4"></a>
...
4. 効率性  
   ...
   これは、リソースの複製を避けることで達成される(「[moveセマンティクス](cpp_idioms.md#SS_12_5_3)」参照)。

5. デフォルト実装  
   move代入演算子が明示的に定義されていない場合でも、
   クラスが一定の条件(例: move不可能なメンバが存在しないこと)を満たしていれば、
   コンパイラがデフォルトの実装(「[特殊メンバ関数](core_lang_spec.md#SS_10_6_1)」参照)を生成する。

---

### CopyAssignable要件 <a id="SS_12_5_5"></a>
...
3. 正しいセマンティクス  
   copy代入によって代入元のオブジェクトが変更されてはならない(「[copyセマンティクス](cpp_idioms.md#SS_12_5_2)」参照)。
...
## 関数設計のガイドライン <a id="SS_12_6"></a>
### 関数の引数と戻り値の型 <a id="SS_12_6_1"></a>
...
### サイクロマティック複雑度のクライテリア <a id="SS_12_6_2"></a>
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_12_14_13)によって下記テーブルのように定義する。
...
### 五の原則(Rule of Five) <a id="SS_12_7_2"></a>
「五の原則」は、
クラスがリソース(例: 動的メモリやファイルハンドルなど)を管理する場合、
デフォルトコンストラクタを除く[特殊メンバ関数](core_lang_spec.md#SS_10_6_1)、
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_12_12_1)」参照)。

なお、「五の原則」は、「六の原則」と呼ばれることもある。
その場合、この原則が対象とする関数は、
[特殊メンバ関数](core_lang_spec.md#SS_10_6_1)のすべてとなる。

このガイドラインに従って、コピーやムーブを実装する場合、

* [等価性のセマンティクス](cpp_idioms.md#SS_12_5_1)
* [copyセマンティクス](cpp_idioms.md#SS_12_5_2)
...
### クラス凝集性のクライテリア <a id="SS_12_7_3"></a>
クラス構造の適・不適については、[PercentLackOfCohesion](cpp_idioms.md#SS_12_14_14_3)によって下記テーブルのように定義することができる。
...
## Robert C. Martinのコンポーネント原則 <a id="SS_12_8"></a>
...
|ヘッダファイル|`*.h` `*.hpp` `*.hxx`                                                                           |
|実装ファイル  |`*.c` `*.cpp` `*.cxx`                                                                           |
|ファイルペア  |`name.h`と`name.c`の組み合わせ /「[ファイルペア](cpp_idioms.md#SS_12_9_1)」で解説                                   |
|モジュール    |モジュール ≒  パッケージ / 「[モジュール](cpp_idioms.md#SS_12_9_3)」で解説                                          |
|パッケージ    |「[パッケージ](cpp_idioms.md#SS_12_9_2)」で解説 / CMake([Modern CMake project layout](cpp_idioms.md#SS_12_10))のビルド単位(ライブラリ) |

ここでは、これらの概念に意味と定義を与える。

- ファイルペア ＝ １つの実装ファイルとヘッダファイル(稀に、実装ファイルやヘッダファイルのみ)
- パッケージ(CMakeのビルド単位) ≒  [Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_12_8)における「コンポーネント」
- パッケージ(CMakeのビルド単位) ∋  (複数の似た機能を持つ)ファイルペア


### ファイルペア <a id="SS_12_9_1"></a>
...
- ファイルペアのファイルの配置は、「[パッケージ内のファイルペアの配置](cpp_idioms.md#SS_12_9_1_1)」で示す。 


#### パッケージ内のファイルペアの配置 <a id="SS_12_9_1_1"></a>
パッケージ内でのファイルペアのヘッダの配置は以下の２パターンのみでなければならない。

- [ファイルペアの機能をパッケージ内部でのみ使用する場合](cpp_idioms.md#SS_12_9_1_1_1)
- [ファイルペアの機能をパッケージが外部公開する場合](cpp_idioms.md#SS_12_9_1_1_2)

##### ファイルペアの機能をパッケージ内部でのみ使用する場合 <a id="SS_12_9_1_1_1"></a>
...
##### ファイルペアの機能をパッケージが外部公開する場合 <a id="SS_12_9_1_1_2"></a>
...
とし、[パッケージ](cpp_idioms.md#SS_12_9_2)としてその粒度を詳細に定義付けている。
...
## Modern CMake project layout <a id="SS_12_10"></a>
...
### Modern CMake project layoutのカスタマイズ <a id="SS_12_10_1"></a>
このドキュメントでは、以下の方針に基づいて[Modern CMake project layout](cpp_idioms.md#SS_12_10)の構成をカスタマイズすることを推奨する。
...
## コーディングスタイル <a id="SS_12_11"></a>
### AAAスタイル <a id="SS_12_11_1"></a>
...
### Trailing Underscore(末尾アンダースコア) <a id="SS_12_11_4"></a>
...
### ケース記法 <a id="SS_12_11_5"></a>
C++の識別子の命名規則(Naming convention)を以下のようにリストアップする。

* [スネークケース(snake_case)](cpp_idioms.md#SS_12_11_5_1)
* [アッパースネークケース(UPPER_SNAKE_CASE)](cpp_idioms.md#SS_12_11_5_2)
* [アッパーキャメルケース(UpperCamelCase)](cpp_idioms.md#SS_12_11_5_3)
* [ロワーキャメルケース(lowerCamelCase)](cpp_idioms.md#SS_12_11_5_4)
* [ケバブケース(kebab-case)](cpp_idioms.md#SS_12_11_5_5)

#### スネークケース(snake_case) <a id="SS_12_11_5_1"></a>
...
#### アッパースネークケース(UPPER_SNAKE_CASE) <a id="SS_12_11_5_2"></a>
...
#### アッパーキャメルケース(UpperCamelCase) <a id="SS_12_11_5_3"></a>
...
#### ロワーキャメルケース(lowerCamelCase) <a id="SS_12_11_5_4"></a>
...
#### ケバブケース(kebab-case) <a id="SS_12_11_5_5"></a>
...
## オブジェクトのコピー <a id="SS_12_12"></a>
### シャローコピー <a id="SS_12_12_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_12_12_2)と対比的に使われる概念である。
...
### ディープコピー <a id="SS_12_12_2"></a>
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_12_12_1)が発生させる問題を回避したコピーである。
...
スライシングが起こった場合、そうならないことが問題である(「[等価性のセマンティクス](cpp_idioms.md#SS_12_5_1)」参照)。
...
## C++注意点 <a id="SS_12_13"></a>
### オーバーライドとオーバーロードの違い <a id="SS_12_13_1"></a>
...
(「[ポリモーフィックなクラス](core_lang_spec.md#SS_10_4_8)」参照)。
...
### danglingリファレンス <a id="SS_12_13_2"></a>
...
### danglingポインタ <a id="SS_12_13_3"></a>
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_12_13_2)と同じような状態になったポインタを指す。


---

### Most Vexing Parse <a id="SS_12_13_4"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_12_13_5"></a>
静的初期化順序問題とは、
...
C++20からこの問題の対策として、[constinit](core_lang_spec.md#SS_10_5_8)が導入された。

[初期化子リストコンストラクタ](core_lang_spec.md#SS_10_6_1_1)の呼び出しでオブジェクトの初期化を行うことで、
このような問題を回避できる。

### Unbounded Functions <a id="SS_12_13_6"></a>
...
## ソフトウェア一般 <a id="SS_12_14"></a>
### ヒープ <a id="SS_12_14_1"></a>
...
### プライオリティインバージョン <a id="SS_12_14_2"></a>
...
C++11では、スピンロックは[std::atomic](stdlib_and_concepts.md#SS_11_4_3)を使用して以下のように定義できる。
...
以下の単体テスト(「[std::mutex](stdlib_and_concepts.md#SS_11_4_2)」の単体テストを参照)
...
### ハンドル <a id="SS_12_14_8"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

---

### フリースタンディング環境 <a id="SS_12_14_9"></a>
...
- メモリ保護違反例外:
    [メモリ保護機構](cpp_idioms.md#SS_12_14_10)の設定に反した命令を実行した場合に発生する。例えば、リードオンリー領域への書き込み、
...
### Fluent Interface <a id="SS_12_14_12"></a>
...
### サイクロマティック複雑度 <a id="SS_12_14_13"></a>
[サイクロマティック複雑度](https://ja.wikipedia.org/wiki/%E5%BE%AA%E7%92%B0%E7%9A%84%E8%A4%87%E9%9B%91%E5%BA%A6)
とは関数の複雑さを表すメトリクスである。

---

### 凝集性 <a id="SS_12_14_14"></a>
[凝集性(凝集度)](https://ja.wikipedia.org/wiki/%E5%87%9D%E9%9B%86%E5%BA%A6)
とはクラス設計の妥当性を表す尺度の一種であり、「[PercentLackOfCohesion](cpp_idioms.md#SS_12_14_14_3)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_12_14_14_1)メトリクスの値が100に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
...
#### 凝集性の欠如 <a id="SS_12_14_14_1"></a>
[凝集性の欠如](cpp_idioms.md#SS_12_14_14_1)とはLack of Cohesion in Methodsの和訳であり、[LCOM](cpp_idioms.md#SS_12_14_14_2)と呼ばれる。

LCOMはメソッドペアの数に基づく非正規化の整数値であるため、
メソッド数が多いクラスほど値が大きくなりやすく、クラス間で単純に値の大小を比較することはできない。
この弱点を補う指標として実務上広く用いられるのが、[PercentLackOfCohesion](cpp_idioms.md#SS_12_14_14_3)である。
...
#### PercentLackOfCohesion <a id="SS_12_14_14_3"></a>
厳密性を欠くが、クラスの凝集性を測定するためには、
テクマトリックス社製のUnderstandのメトリクスPercentLackOfCohesionを使用するのが実践的である。

PercentLackOfCohesionは、[LCOM](cpp_idioms.md#SS_12_14_14_2)と同様に使用できるメトリクスであり、0〜100に正規化された値である。

[クラス凝集性のクライテリア](cpp_idioms.md#SS_12_7_3)に示した通り、構造的欠陥をを持つクラスの自動的な抽出に有用である。

---

### Spurious Wakeup <a id="SS_12_14_15"></a>
...
### Itanium C++ ABI <a id="SS_12_14_17"></a>
...
[g++](cpp_idioms.md#SS_12_15_1)や[clang++](cpp_idioms.md#SS_12_15_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
...
## 非ソフトウェア用語 <a id="SS_12_16"></a>
### セマンティクス <a id="SS_12_16_1"></a>
