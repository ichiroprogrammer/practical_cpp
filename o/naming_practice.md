...
&emsp;&emsp; [禁止事項](naming_practice.md#SS_5_1)  
&emsp;&emsp;&emsp; [略語リスト](naming_practice.md#SS_5_1_1)  
&emsp;&emsp;&emsp; [言葉の対称性](naming_practice.md#SS_5_1_2)  

&emsp;&emsp; [識別子の命名](naming_practice.md#SS_5_2)  
&emsp;&emsp;&emsp; [ファイル、ディレクトリの命名](naming_practice.md#SS_5_2_1)  
&emsp;&emsp;&emsp; [ファイル名](naming_practice.md#SS_5_2_2)  
&emsp;&emsp;&emsp; [ディレクトリ名](naming_practice.md#SS_5_2_3)  
&emsp;&emsp;&emsp; [型名](naming_practice.md#SS_5_2_4)  
&emsp;&emsp;&emsp; [定数名](naming_practice.md#SS_5_2_5)  
&emsp;&emsp;&emsp; [ローカル変数名(自動変数名、仮引数名、関数内static変数名)](naming_practice.md#SS_5_2_6)  
&emsp;&emsp;&emsp; [メンバ変数名](naming_practice.md#SS_5_2_7)  
&emsp;&emsp;&emsp; [メンバ関数名](naming_practice.md#SS_5_2_8)  
&emsp;&emsp;&emsp; [Accessorメンバ関数名](naming_practice.md#SS_5_2_9)  
&emsp;&emsp;&emsp; [関数名](naming_practice.md#SS_5_2_10)  
&emsp;&emsp;&emsp; [名前空間名](naming_practice.md#SS_5_2_11)  
&emsp;&emsp;&emsp; [テンプレート名](naming_practice.md#SS_5_2_12)  
&emsp;&emsp;&emsp; [テンプレートの仮引数名](naming_practice.md#SS_5_2_13)  
&emsp;&emsp;&emsp; [マクロ名](naming_practice.md#SS_5_2_14)  
&emsp;&emsp;&emsp; [その他の命名則](naming_practice.md#SS_5_2_15)  
...
* 英文字の大小で識別子を区別しない。
  ただし、「[NVI(non virtual interface)](cpp_idioms.md#SS_12_1_7)」を使用するメンバ関数名は例外とする。
...
* 対照的概念に非対称な名前(startとend、topとdown等)を付けない
  (「[言葉の対称性](naming_practice.md#SS_5_1_2)」参照)。

### 略語リスト <a id="SS_5_1_1"></a>
...
この際、[クラスのコメント](comment.md#SS_6_2_1)、[関数のコメント](comment.md#SS_6_2_2)のフォーマットをchapgptに伝えれば、
より良いコードが作られる。問題点を修正し、それをchatgptにに張り付け、
単体テストをgtestで書くように依頼すれば、単体テスト付きのコードが入手できる。


### ファイル、ディレクトリの命名 <a id="SS_5_2_1"></a>
...
### ローカル変数名(自動変数名、仮引数名、関数内static変数名) <a id="SS_5_2_6"></a>
...
### メンバ変数名 <a id="SS_5_2_7"></a>
* ローカル変数名と同じルールで生成した文字列に[Trailing Underscore(末尾アンダースコア)](cpp_idioms.md#SS_12_9_4)を適用する。
  (visual studioで開発を行うプロジェクトを除きメンバ変数をm'\_'で始めことはしない)。
* [POD](core_lang_spec.md#SS_10_4_5)のメンバ変数の名前は、ローカル変数名と同じルールで生成する(末尾に'\_'はつけない)。
...
### Accessorメンバ関数名 <a id="SS_5_2_9"></a>
* 慣習に従うと機能が類推しやすいため、 
  一般的な[Accessor](cpp_idioms.md#SS_12_1_5)メンバ関数には、以下のような接頭語をつける。
...
### 関数名 <a id="SS_5_2_10"></a>
* 非メンバ関数の名前は、型名と同じルールで生成する。

### 名前空間名 <a id="SS_5_2_11"></a>
