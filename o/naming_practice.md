...
[禁止事項](naming_practice.md#SS_5_1)  
&emsp;[略語リスト](naming_practice.md#SS_5_1_1)  
&emsp;[言葉の対称性](naming_practice.md#SS_5_1_2)  

[識別子の命名](naming_practice.md#SS_5_2)  
&emsp;[ファイル、ディレクトリの命名](naming_practice.md#SS_5_2_1)  
&emsp;[ファイル名](naming_practice.md#SS_5_2_2)  
&emsp;[ディレクトリ名](naming_practice.md#SS_5_2_3)  
&emsp;[型名](naming_practice.md#SS_5_2_4)  
&emsp;[定数名](naming_practice.md#SS_5_2_5)  
&emsp;[ローカル変数名(自動変数名、仮引数名、関数内static変数名)](naming_practice.md#SS_5_2_6)  
&emsp;[メンバ変数名](naming_practice.md#SS_5_2_7)  
&emsp;[メンバ関数名](naming_practice.md#SS_5_2_8)  
&emsp;[Accessorメンバ関数名](naming_practice.md#SS_5_2_9)  
&emsp;[関数名](naming_practice.md#SS_5_2_10)  
&emsp;[名前空間名](naming_practice.md#SS_5_2_11)  
&emsp;[テンプレート名](naming_practice.md#SS_5_2_12)  
&emsp;[テンプレートの仮引数名](naming_practice.md#SS_5_2_13)  
&emsp;[マクロ名](naming_practice.md#SS_5_2_14)  
&emsp;[その他の命名則](naming_practice.md#SS_5_2_15)  
...
* 英文字の大小で識別子を区別しない。
  ただし、「[NVI(non virtual interface)](cpp_idioms.md#SS_12_1_8)」を使用するメンバ関数名は例外とする。
...
コードの可読性に大きな影響を与える識別子名は[パッケージ](cpp_idioms.md#SS_12_9_2)外部に公開されるクラス、関数、名前空間等の名称である。
...
ファイル名(や[ファイルペア](cpp_idioms.md#SS_12_9_1)名)、ディレクトリ名は、ソフトウェアを構成する[パッケージ](cpp_idioms.md#SS_12_9_2)やその構成物から、
強い影響を受けるべきである。
...
* ローカル変数名と同じルールで生成した文字列に[Trailing Underscore(末尾アンダースコア)](cpp_idioms.md#SS_12_11_4)を適用する。
...
* 慣習に従うと機能が類推しやすいため、 
  一般的な[Accessor](cpp_idioms.md#SS_12_1_6)メンバ関数には、以下のような接頭語をつける。
