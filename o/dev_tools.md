...
* コンパイルが速い。
* カバレッジの計測ができる(「[単体テストのサポートツール](process_and_infra.md#SS_8_2_1_4)」参照)。
...
PC上のコンパイラを使用した単体テストを推奨している(「[単体テストのサポートツール](process_and_infra.md#SS_8_2_1_4)」参照)。
...
* 組み込みアプリケーションの開発では下記のようにしている。
    * 単体テスト(「[単体テストのサポートツール](process_and_infra.md#SS_8_2_1_4)」参照)に関してはlinuxと同じ。
