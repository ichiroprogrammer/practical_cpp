...
(この実装は長いため、
全体は巻末の「[example/dynamic_memory_allocation/malloc_ut.cpp](sample_code.md#SS_23_2_35)」に掲載する)。
...
* その他のクラスに対しては、[Singleton](design_pattern.md#SS_11_1_1)や[Named Constructor](design_pattern.md#SS_11_1_2)と同様な静的な方法を用いる
